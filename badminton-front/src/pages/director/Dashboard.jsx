...
import BreakModePanel from "../../components/director/BreakModePanel";
...
function StatCard({ label, value, accent, sub }) {
  return (
    <div
      style={{
        ...S.card,
        borderColor: accent ? `${accent}33` : "rgba(255,255,255,0.06)",
      }}
    >
...
function MatchRow({ m }) {
  ...
  const clr =
    { Live: "#c8ff00", Completed: "#888", Upcoming: "#4af" }[status] || "#888";
  ...
  return (
    <div style={S.matchRow}>
      <div style={{ ...S.pill, background: `${clr}22`, color: clr }}>
        {status}
      </div>
  ...
  return (
    <div style={S.page}>
      ...
      <div style={S.stats}>
        ...
        <StatCard
          label="Live now"
          value={liveArr.length}
          accent="#ff4444"
          sub={liveArr.length ? "● On court" : "No live matches"}
        />
